...
internal class PostRepository : IPostRepository
{
	...
	public async Task<bool> PostExistsByIdAsync(string idPost, CancellationToken cancellationToken = default)
	{
		idPost = idPost.ToLower();
		return await _context.Posts.Where(p => p.IdPost == idPost).AnyAsync(cancellationToken);
	}
}
