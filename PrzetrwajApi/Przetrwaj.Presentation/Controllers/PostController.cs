...
public partial class PostController : Controller
{
	...
	[ProducesResponseType(typeof(ExceptionCasting), StatusCodes.Status404NotFound)]
	public async Task<IActionResult> AddComment(int id, CancellationToken CT)
	{
		throw new NotImplementedException();
	}
	...
	public async Task<IActionResult> VotePositive(int id, CancellationToken CT)
	{
		throw new NotImplementedException();
	}
	...
	[ProducesResponseType(typeof(ExceptionCasting), StatusCodes.Status404NotFound)]
	[ProducesResponseType(typeof(ExceptionCasting), StatusCodes.Status409Conflict)] //already voted
	public async Task<IActionResult> VoteNegative(int id, CancellationToken CT)
	{
		throw new NotImplementedException();
	}
