    ...
    private async Task GetUserInfo()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                UserUpdateRequest.Email = userPrincipal.Claims.FirstOrDefault(c => c.Type == ClaimTypes.Email)?.Value ?? string.Empty;
    ...
    private async Task GetUserDetailsFromApi(Task<HttpResponseMessage> getUserDetailsTask)
    {
        ...
        if (userDetails.IsSuccessStatusCode)
        {
            ...
            if (userInfo != null)
            {
                ...
                UserUpdateRequest.Email = userInfo.Email ?? string.Empty;
